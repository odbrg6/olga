...
async def variable(var):
    ...
    if exe == "قروب التخزين":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⋗ تم بنجاح تغيير فار قروب التخزين\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
...
async def variable(event):
    ...
    if exe == "قروب التخزين":
        ...
        if variable not in heroku_var:
            return await edit_or_reply(
                event, "**⋗ لم تتم اضافه فار قروب التخزين بالاصل.**"
            )
        await edit_or_reply(
            event,
            "**⋗ تم بنجاح حذف فار قروب التخزين\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
        del heroku_var[variable]
    if exe == "قروب الحفظ":
        variable = "PRIVATE_GROUP_BOT_API_ID"
        ...
        if variable not in heroku_var:
            return await edit_or_reply(
                event, "**⋗ لم تتم اضافه فار قروب الحفظ بالاصل.**"
            )
        await edit_or_reply(
            event,
            "**⋗ تم بنجاح حذف فار قروب الحفظ\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
