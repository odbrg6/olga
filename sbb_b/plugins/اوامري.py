...
ROE = "** ꒱ ِ  هَذه هي قائمة اوامـر سورس أولكَا   𓏲 :**"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == sbb_b.uid:
            buttons = [
                [Button.inline("꒱ ِمعلومات أولكَا  𓏲 :", data="AOMRDB")],
                [
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @B_F49
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس بيدو @B_F49""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
