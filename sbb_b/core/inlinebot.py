...
CATLOGO = "https://telegra.ph/file/dc793d988821101e536f4.png"
...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧ𝐎𝐋𝐆𝐀 ⵧⵧⵧⵧⵧ⍣**\n[ 𝐎𝐋𝐆𝐀 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/B_F49)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/B_F49"),
                )
            ]
            ...
            result = builder.article(
                title="sbb_b Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب أولكَا **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/B_F49"),
                Button.url(
                    "المطور",
                    "t.me/f444or",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل أولكَا من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝐎𝐋𝐆𝐀 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/B_F49)",
