...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("تنصيب أولكَا ❤️", "https://t.me/B_F49"),
                Button.url(
                    "مساعدة ❓",
                    "https://t.me/f444or",
                ),
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/B_F49"),
            ],
            [
