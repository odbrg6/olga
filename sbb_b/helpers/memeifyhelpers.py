...
from wand.image import Image as olgaimage
...
async def olga_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def olga_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = olgaimage(filename=picture_name)
    main_image.resize(
