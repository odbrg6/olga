...
async def yt_search(olga):
    try:
        olga = urllib.parse.quote(olga)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={olga}"
        )
...
"""
async def yt_data(olga):
    params = {"format": "json", "url": olga}
